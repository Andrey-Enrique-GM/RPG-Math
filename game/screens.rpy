...
screen main_menu():
    ...
    # AQUI SE COLOCA LA MUSICA DE FONDO DEL MAIN MENU
    on "show" action Play("music", "audio/Katawa Shoujo OST - Wiosna.mp3", fadein=1.0)

    # AQUI SE COLOCA LA IMAGEN DE FONDO DEL MAIN MENU
    add "images/menu.png"
...
screen about():
    ...
    use game_menu(_("Acerca de"), scroll="viewport"):
        ...
        vbox:
            ...
            text "Mi Repositorio en GitHub: https://github.com/Andrey-Enrique-GM/RPG-Math"
            text "Hecho por Andrey Enrique Gonzalez Munguia\n"

            text "Música de fondo: \nKatawa Shoujo: https://www.katawa-shoujo.online \nDoki Doki Literature Club!: https://ddlc.moe\n\n"
